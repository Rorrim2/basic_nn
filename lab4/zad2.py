...
for i in range(number_of_iterations):
    print(i)
    for image in range(int(number_of_images/mini_batch_stack)):
...
#40, 1000, 1000, 350 - 836/1000
#100, 10000, 10000, 350 - 9168/10000
#100, 60000, 10000, 350 - 9266/10000